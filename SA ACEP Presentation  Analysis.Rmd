...
table.1 <- cohort.2 %>% 
  select(pathway, age, female, race_bwo, under120h) %>% 
  set_variable_labels(age = "Age",  female = "Female", race_bwo = "Race", under120h = "Presented within 120 hours after assault") %>% 
  tbl_summary(
    by = pathway,
    missing = "ifany", 
    percent = "column",
