...
table.1 <- cohort.2 %>% 
  select(pathway, age, female, race_bwo, under120h, english, ambulance, insurance) %>% 
  set_variable_labels(age = "Age",  female = "Female", race_bwo = "Race", under120h = "Presented within 120 of assault", ambulance = "Arrived by EMS", english = "English speaking", insurance = "Insurance") %>% 
  tbl_summary(
    by = pathway,
    missing = "ifany", 
    percent = "column",
