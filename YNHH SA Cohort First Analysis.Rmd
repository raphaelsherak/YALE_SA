...
table.1 <- cohort.2 %>% 
  select(pathway, age, age_3_group, female, race_bwo, contacted_advocate, sane_kit_YN, sane_kit_missed, trauma_case_yn, time_since_sexual_assault_if_number_k_is_y) %>% 
